...
urlpatterns = [
    ...
    path('home_user/<str:id>/marketplace_user/', app.views.marketplace_user, name='marketplace_user'),
    path('home_user/<str:id>/marketplace_user/view/<str:id>', app.views.view, name='view'),
